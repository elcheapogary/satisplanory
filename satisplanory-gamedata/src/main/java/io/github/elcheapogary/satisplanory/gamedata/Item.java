...
public class Item
{
    ...
    public static Item fromJson(JsonObject json)
    {
        return new Item.Builder()
                ...
                .setMatterState(MatterState.valueOf(json.getString("matterState")))
                .setSinkValue(json.getInt("sinkValue"))
                .build();
    }
    ...
    public JsonObject toJson()
    {
        return Json.createObjectBuilder()
                ...
                .add("matterState", matterState.name())
                .add("description", description)
                .add("sinkValue", sinkValue)
                .build();
    }
