...
public class FlowLayout extends OrderedLayout {
	...
	/**
	 * @see AbstractLayout#calculatePreferredSize(IFigure, int,
	 *      int)
	 */
	 ...
	 * 
	 * @see OrderedLayout#getDefaultOrientation()
	 */
	...
	/**
	 * @see AbstractHintLayout#isSensitiveHorizontally(IFigure)
	 */
	...
	/**
	 * @see AbstractHintLayout#isSensitiveVertically(IFigure)
	 */
	 ...
	 * 
	 * @see OrderedLayout#isStretchMinorAxis()
	 */
	 ...
	 * Overwritten to guarantee backwards compatibility with {@link #fill} field.
	 * 
	 * @see OrderedLayout#setStretchMinorAxis(boolean)
	 */
