...
/**
 * Similar to a {@link ChopboxAnchor}, except this anchor is
...
public class EllipseAnchor extends AbstractConnectionAnchor {
	...
	/**
	 * @see AbstractConnectionAnchor#AbstractConnectionAnchor()
	 */
	public EllipseAnchor() {
	}

	/**
	 * @see AbstractConnectionAnchor#AbstractConnectionAnchor(IFigure)
	 */
