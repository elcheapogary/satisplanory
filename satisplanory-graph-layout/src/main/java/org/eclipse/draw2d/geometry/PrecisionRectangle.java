...
public final class PrecisionRectangle extends Rectangle {
	...
	/**
	 * @see Rectangle#contains(double, double)
	 */
	...
	private boolean containsPrecise(double x, double y) {
		return y >= preciseY() && y < preciseY() + preciseHeight() && x >= preciseX()
				&& x < preciseX() + preciseWidth();
	}
	...
	/**
	 * @see Rectangle#performScale(double)
	 */
	...
	/**
	 * @see Rectangle#performTranslate(int, int)
	 */
	...
	/**
	 * @see Rectangle#resize(Dimension)
	 */
	...
	/**
	 * @see Rectangle#resize(double, double)
	 */
	...
	/**
	 * @see Rectangle#setBounds(Rectangle)
	 */
	...
	/**
	 * @see Rectangle#setSize(Dimension)
	 */
	...
	/**
	 * @see Rectangle#touches(Rectangle)
	 */
	...
	/**
	 * @see Rectangle#translate(double, double)
	 */
	...
	/**
	 * @see Rectangle#union(double, double)
	 */
	...
	/**
	 * @see Rectangle#union(double, double, double,
	 *      double)
	 */
	...
	/**
	 * @see Rectangle#union(int, int, int, int)
	 */
