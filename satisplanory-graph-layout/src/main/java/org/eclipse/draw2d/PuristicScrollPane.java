...
public class PuristicScrollPane extends ScrollPane {
	...
	public class PuristicScrollBar extends ScrollBar {
		...
		/**
		 * @see ScrollBar#createDefaultDownButton()
		 */
		...
		/**
		 * @see ScrollBar#createDefaultThumb()
		 */
		...
		/**
		 * @see ScrollBar#createDefaultUpButton()
		 */
	...
	/**
	 * @see ScrollPane#createVerticalScrollBar()
	 */
	...
	/**
	 * @see ScrollPane#createHorizontalScrollBar()
	 */
