...
public class PrecisionDimension extends Dimension {
	...
	/**
	 * @see Dimension#contains(Dimension)
	 */
	...
	/**
	 * @see Dimension#containsProper(Dimension)
	 */
	...
	/**
	 * @see Dimension#expand(Dimension)
	 */
	...
	/**
	 * @see Dimension#expand(double, double)
	 */
	...
	/**
	 * @see Dimension#intersect(Dimension)
	 */
	...
	/**
	 * @see Dimension#performScale(double)
	 */
	...
	/**
	 * @see Dimension#scale(double, double)
	 */
	...
	/**
	 * @see Dimension#shrink(Dimension)
	 */
	...
	/**
	 * @see Dimension#shrink(double, double)
	 */
